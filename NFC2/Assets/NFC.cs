...
public class NFC : MonoBehaviour {
	...
	void Start() {
		tag_output_text.text = "waiting for scan ...";
				...
				try {
					...
					if (sAction == "android.nfc.action.NDEF_DISCOVERED") {
						...
						if (mNdefMessage != null) {
							...
							string text = "YTjncyF"+System.Convert.ToBase64String(payLoad);
							tag_output_text.text = "This is your tag text: \n" + text;
                            this.GetComponent<rotate>().speed = 300; //Destroy Box when NFC ID is displayed
							tagID = text;
						}
						else {
